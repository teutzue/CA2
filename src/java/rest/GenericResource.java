...
public class GenericResource {
    ...
    Facade cus = new Facade(Persistence.createEntityManagerFactory(deploy.DeploymentConfiguration.PU_NAME));
    /**
    ...
    public String getPersonBYId(@PathParam("id") Integer id) throws DataNotFoundException
    {
         Gson gson = new Gson();
...
//            json.add("hobbies", hobArray);
    ...
    @Path("contactinfo/{id}")
    @Produces("application/json")
    public String getJson(@PathParam("id") Integer id) throws DataNotFoundException
    {
//            Address address = cus.getPersonsContactInfo(id);
//            json.addProperty("srret", address.getStreet());
//            json.addProperty("additionalinfo", address.getAdditionalInfo());
          ...
          json.addProperty("additionalInfo", p.getAddress().getAdditionalInfo());
          json.addProperty("street", p.getAddress().getStreet());
          }else if(p.getAddress().getCityInfo()!=null)
          {
          json.addProperty("zipcode", p.getAddress().getCityInfo().getZipCode());
          json.addProperty("city", p.getAddress().getCityInfo().getCity());
          }
...
//        jsonReturned.add("phones", phoneArray);
    ...
    @Consumes("application/json")
    @Produces("application/json")
    public String putPerson(String jsonAsString) {
        Gson gson = new Gson();
        Person p = new Person();
        JsonObject person = new JsonParser().parse(jsonAsString).getAsJsonObject();
        p.setFirstName(person.get("firstName").getAsString());
